 ...
 */
public class SearchProductSuggestionAdapter extends CursorAdapter {
    private final String TAG = "SearchProductSuggestionAdapter";
    ArrayList<Product> mProducts;
    ArrayList<Product> mProducts1;
    private LayoutInflater mInflater;
    private String[] mFields = {"_id", "name"};

    public SearchProductSuggestionAdapter(Context context, ArrayList<Product> products) {
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        return new SearchProductSuggestionCursor(constraint);
    }
    ...
    private class SearchProductSuggestionCursor extends AbstractCursor {

        public SearchProductSuggestionCursor(CharSequence constraint) {
